...
ParticleM* ParticleM::GetInstance() {
	static ParticleM instance;
	return &instance;
}

void ParticleM::Initialize(ID3D12Device* device) {
	// nullptrチェック
	assert(device);
...
void ParticleM::Add(int life, XMFLOAT3 position, XMFLOAT3 velocity, XMFLOAT3 accel, float start_scale, float end_scale) {
	// リストに要素を追加
...
void ParticleM::InitializeGraphicsPipeline() {
	HRESULT result = S_FALSE;
